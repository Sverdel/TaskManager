...
namespace TaskManager.Api.Controllers.Tests
{
    ...
    public class ResourceControllerTests
    {
        ...
        public async Task GetStatesTest()
        {
            ...
            System.Web.Http.IHttpActionResult result = await controller.GetStates().ConfigureAwait(false);
        ...
        {
            ResourceController controller = new ResourceController();
            System.Web.Http.IHttpActionResult result = await controller.GetPriorities().ConfigureAwait(false);
