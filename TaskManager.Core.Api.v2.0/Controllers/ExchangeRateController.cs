...
namespace TaskManager.Core.Api.v2._0.Controllers
{
    ...
    public class ExchangeRateController : Controller
    {
        ...
        private List<string> _currencies = new List<string> { "AUD", "AZN", "GBP", "AMD", "BYN", "BGN", "BRL", "HUF", "HKD", "DKK", "USD", "EUR", "INR", "KZT", "CAD", "KGS", "CNY", "MDL", "NOK", "PLN", "RON", "XDR", "SGD", "TJS", "TRY", "TMT", "UZS", "UAH", "CZK", "SEK", "CHF", "ZAR", "KRW", "JPY" };
